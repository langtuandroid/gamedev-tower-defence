...
public class VideoReward : MonoBehaviour
{
    ...
    public static VideoReward Instance { set; get; }
#if UNITY_IOS
  ...
  int retryAttempt;
  public int _idRewardButton;

  public AppMetEvents _appMetEvents;
  public int _internetConnection = 1;
  [SerializeField] public AdsButton _boosts;
  public SpellsWrapper _spellWrapper;
  public Rampage _rampage;
  public QuestManager _questManager;
  public EarnBuild _earnOffline;
  [SerializeField] public ButtonInfo[] _buttonInfo;
  [SerializeField] public TowerWrapper _towerWrapper;
  [SerializeField] public WarriorsCoreUpgrade[] _warriorsUpgrades;
  [SerializeField] public UpgradeDetails[] _upgradesDetails;
  [SerializeField] public TextMeshProUGUI _rewardMoneyDisplayText;
  [SerializeField] public AddWarriors _addWarriors;
  [SerializeField] public RandomSpell _randomSpell;
  public GameUI _gameUI;
  public Wallet _wallet;
  public static int rewardMoneyCounter;
